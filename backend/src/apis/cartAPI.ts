...
/**
 * @api {patch} /api/cart 장바구니 상풍 목록 개수 업데이트
 * @apiHeader {String} Authorization Users unique token.
 * @apiName Update Cart Amount
 * @apiGroup Cart
 *
 * @apiParam {String} id       상품 아이디.
...
/**
 * @api {patch} /api/cart/checked 장바구니 상품 체크 상태 변경
 * @apiHeader {String} Authorization Users unique token.
 * @apiName Update Cart Check State
 * @apiGroup Cart
 *
 * @apiParam {String} id       상품 아이디.
...
/**
 * @api {patch} /api/cart/checked/all 장바구니 상품 체크 상태 변경
 * @apiHeader {String} Authorization Users unique token.
 * @apiName Update All Cart Check
 * @apiGroup Cart
 *
 * @apiParam {String} checked        상품 체크 상태.
 *
